...
struct OldCSE : public CSEBase<OldCSE> {
...
LogicalResult OldCSE::simplifyOperation(ScopedMapTy &knownValues, Operation *op) {
...
void OldCSE::simplifyBlock(ScopedMapTy &knownValues, DominanceInfo &domInfo,
                        Block *bb) {
  for (auto &inst : *bb) {
...
void OldCSE::simplifyRegion(ScopedMapTy &knownValues, DominanceInfo &domInfo,
                         Region &region) {
...
std::unique_ptr<Pass> mlir::createOldCSEPass() { return std::make_unique<OldCSE>(); }
