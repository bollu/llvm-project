//===- OldMemRefDataFlowOpt.cpp - MemRef DataFlow Optimization pass ------ -*-===//
//
...
#define DEBUG_TYPE "old-memref-dataflow-opt"
...
// than dealloc) remain.
//
struct OldMemRefDataFlowOpt : public MemRefDataFlowOptBase<OldMemRefDataFlowOpt> {
  ...
  OldDominanceInfo *domInfo = nullptr;
  OldPostDominanceInfo *postDomInfo = nullptr;
};
...
std::unique_ptr<OperationPass<FuncOp>> mlir::createOldOldMemRefDataFlowOptPass() {
  return std::make_unique<OldMemRefDataFlowOpt>();
}

// This is a straightforward implementation not optimized for speed. Optimize
// if needed.
void OldMemRefDataFlowOpt::forwardStoreToLoad(AffineReadOpInterface loadOp) {
...
void OldMemRefDataFlowOpt::runOnFunction() {
  ...
  domInfo = &getAnalysis<OldDominanceInfo>();
  postDomInfo = &getAnalysis<OldPostDominanceInfo>();
