...
#ifndef LLVM_TRANSFORMS_IPO_BITCAST_CALL_CONVERTER
#define LLVM_TRANSFORMS_IPO_BITCAST_CALL_CONVERTER
...
class BitcastCallConverterPass : public PassInfoMixin<BitcastCallConverterPass> {

public:
  BitcastCallConverterPass() {}
...
#endif // LLVM_TRANSFORMS_IPO_BITCAST_CALL_CONVERTER
